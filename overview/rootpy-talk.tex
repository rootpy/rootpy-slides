...
{\em ``Pythonic means code that doesn't just get the syntax right but that follows
  ...
  \vskip1mm
  \hspace*\fill{\small--- \href{http://stackoverflow.com/a/25011492/1002176}{stackoverflow}}
\end{exampleblock}

\vspace{.5cm}
{\small * Capitalization is important. ROOTPy, RootPy, etc. are all unacceptable.}
