...
\begin{frame}[fragile]
    ...
    \begin{quote}
    ``Hello world! I am a PhD student in High Energy Physics at Simon Fraser
    University looking for the Higgs boson as a member of the ATLAS
...
\frame{
    ...
    \begin{center}
    \includegraphics[height=.7\textwidth]{figs/rootpy-map.png}
    \end{center}
    
    cern is not official software, separate repository on github
}
...
\frame{
    ...
    Future dev plans
    Better IPython support.
    Online documentation and tutorials.
    ROOT 6? Python 3?
    Maybe someday an officially supported extension of ROOT?
}
